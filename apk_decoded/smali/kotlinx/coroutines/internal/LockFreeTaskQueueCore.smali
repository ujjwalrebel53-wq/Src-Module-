...
.method private final markFrozen()J
    ...
    .local v1, "$this$updateAndGet$iv":Lkotlinx/coroutines/internal/LockFreeTaskQueueCore;
    const/4 v6, 0x0

    .line 335
    .local v6, "$i$f$updateAndGet":I
    :goto_0
    nop

    .line 336
    iget-wide v2, v1, Lkotlinx/coroutines/internal/LockFreeTaskQueueCore;->_state:J
    ...
    .line 218
    .local v0, "$i$a$-updateAndGet-LockFreeTaskQueueCore$markFrozen$1":I
    ...
    .line 338
    .end local v0    # "$i$a$-updateAndGet-LockFreeTaskQueueCore$markFrozen$1":I
    .local v4, "upd$iv":J
    ...
    .line 220
    .end local v1    # "$this$updateAndGet$iv":Lkotlinx/coroutines/internal/LockFreeTaskQueueCore;
    .end local v2    # "cur$iv":J
    .end local v4    # "upd$iv":J
    .end local v6    # "$i$f$updateAndGet":I
    return-wide v4

    .line 335
    .restart local v1    # "$this$updateAndGet$iv":Lkotlinx/coroutines/internal/LockFreeTaskQueueCore;
    .restart local v6    # "$i$f$updateAndGet":I
    :cond_1
    goto :goto_0
.end method
...
.method private final removeSlowPath(II)Lkotlinx/coroutines/internal/LockFreeTaskQueueCore;
    ...
    .local v6, "$this$loop$iv":Lkotlinx/coroutines/internal/LockFreeTaskQueueCore;
    const/4 v7, 0x0
    ...
    .line 200
    .local v8, "$i$a$-loop-LockFreeTaskQueueCore$removeSlowPath$1":I
    ...
    invoke-virtual {v4, v2, v3, v5}, Lkotlinx/coroutines/internal/LockFreeTaskQueueCore$Companion;->updateHead(JI)J
    ...
    .end local v8    # "$i$a$-loop-LockFreeTaskQueueCore$removeSlowPath$1":I
    goto :goto_0
.end method
...
.method public final addLast(Ljava/lang/Object;)I
    ...
    .line 320
    iget-wide v2, v7, Lkotlinx/coroutines/internal/LockFreeTaskQueueCore;->_state:J

    .local v2, "state":J
    const/4 v9, 0x0

    .line 106
    .local v9, "$i$a$-loop-LockFreeTaskQueueCore$addLast$1":I
    ...
    .local v7, "tail":I
    .local v22, "tail$iv":I
    .local v23, "$this$loop$iv":Lkotlinx/coroutines/internal/LockFreeTaskQueueCore;
    invoke-virtual/range {v0 .. v5}, Ljava/util/concurrent/atomic/AtomicLongFieldUpdater;->compareAndSet(Ljava/lang/Object;JJ)Z
    ...
    .line 133
    iget-wide v4, v0, Lkotlinx/coroutines/internal/LockFreeTaskQueueCore;->_state:J
    ...
    .line 319
    .end local v2    # "state":J
    .end local v9    # "$i$a$-loop-LockFreeTaskQueueCore$addLast$1":I
    :goto_4
...
.method public final close()Z
    ...
    .local v1, "$this$update$iv":Lkotlinx/coroutines/internal/LockFreeTaskQueueCore;
    const/4 v6, 0x0
    ...
    .line 96
    .local v0, "$i$a$-update-LockFreeTaskQueueCore$close$1":I
    ...
    .line 318
    .end local v0    # "$i$a$-update-LockFreeTaskQueueCore$close$1":I
    .local v4, "upd$iv":J
    sget-object v0, Lkotlinx/coroutines/internal/LockFreeTaskQueueCore;->_state$FU:Ljava/util/concurrent/atomic/AtomicLongFieldUpdater;
    ...
    .line 100
    .end local v1    # "$this$update$iv":Lkotlinx/coroutines/internal/LockFreeTaskQueueCore;
...
.method public final removeFirstOrNull()Ljava/lang/Object;
    ...
    .line 166
    .local v8, "$i$a$-loop-LockFreeTaskQueueCore$removeFirstOrNull$1":I
    const-wide/high16 v4, 0x1000000000000000L
    ...
    .end local v6    # "$this$loop$iv":Lkotlinx/coroutines/internal/LockFreeTaskQueueCore;
    ...
    .end local v8    # "$i$a$-loop-LockFreeTaskQueueCore$removeFirstOrNull$1":I
    .end local v9    # "this_$iv":Lkotlinx/coroutines/internal/LockFreeTaskQueueCore$Companion;
    .end local v10    # "$this$withState$iv":J
    .end local v12    # "$i$f$withState":I
    .end local v13    # "head$iv":I
    ...
    .end local v16    # "$i$a$-withState-LockFreeTaskQueueCore$removeFirstOrNull$1$1":I
