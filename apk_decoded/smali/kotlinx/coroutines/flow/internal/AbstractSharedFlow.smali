...
.method protected final allocateSlot()Lkotlinx/coroutines/flow/internal/AbstractSharedFlowSlot;
    ...
    .line 59
    .local v4, "slot":Lkotlinx/coroutines/flow/internal/AbstractSharedFlowSlot;
    :cond_2
    nop
    ...
    .line 63
    :cond_4
    invoke-virtual {v4, p0}, Lkotlinx/coroutines/flow/internal/AbstractSharedFlowSlot;->allocateLocked(Ljava/lang/Object;)Z
    ...
    .local v6, "subscriptionCount":Ljava/lang/Object;
    nop
    ...
    .end local v4    # "slot":Lkotlinx/coroutines/flow/internal/AbstractSharedFlowSlot;
    ...
    .line 71
    .restart local v4    # "slot":Lkotlinx/coroutines/flow/internal/AbstractSharedFlowSlot;
    if-eqz v6, :cond_5
    ...
    .line 68
    .end local v4    # "slot":Lkotlinx/coroutines/flow/internal/AbstractSharedFlowSlot;
    .end local v6    # "subscriptionCount":Ljava/lang/Object;
...
.method protected final freeSlot(Lkotlinx/coroutines/flow/internal/AbstractSharedFlowSlot;)V
    ...
    .line 91
    .local v3, "resumes":[Lkotlin/coroutines/Continuation;
    array-length v1, v3
    ...
    .line 84
    .end local v3    # "resumes":[Lkotlin/coroutines/Continuation;
    .restart local v1    # "$i$f$synchronized":I
    :catchall_0
    move-exception v2
