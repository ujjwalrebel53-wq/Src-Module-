...
.method private final finalizeFinishingState(Lkotlinx/coroutines/JobSupport$Finishing;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    .line 219
    .local v8, "finalException":Ljava/lang/Throwable;
    nop
    ...
    invoke-direct {v5, v8, v2, v6, v3}, Lkotlinx/coroutines/CompletedExceptionally;-><init>(Ljava/lang/Throwable;ZILkotlin/jvm/internal/DefaultConstructorMarker;)V
    ...
    .line 229
    invoke-direct {p0, v8}, Lkotlinx/coroutines/JobSupport;->cancelParent(Ljava/lang/Throwable;)Z

    move-result v3

    if-nez v3, :cond_d

    invoke-virtual {p0, v8}, Lkotlinx/coroutines/JobSupport;->handleJobException(Ljava/lang/Throwable;)Z
    ...
    const-string v3, "null cannot be cast to non-null type kotlinx.coroutines.CompletedExceptionally"
    ...
    invoke-virtual {p0, v8}, Lkotlinx/coroutines/JobSupport;->onCancelling(Ljava/lang/Throwable;)V
    ...
    .end local v8    # "finalException":Ljava/lang/Throwable;
    .local v5, "$i$f$synchronized":I
    :catchall_0
    move-exception v1
...
.method private final makeCancelling(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    .line 747
    .local v6, "notifyRootCause":Ljava/lang/Throwable;
    if-eqz v6, :cond_6
    ...
    invoke-direct {p0, v8, v5}, Lkotlinx/coroutines/JobSupport;->notifyCancelling(Lkotlinx/coroutines/NodeList;Ljava/lang/Throwable;)V
    ...
    .end local v6    # "notifyRootCause":Ljava/lang/Throwable;
    .local v5, "$i$f$synchronized":I
    ...
    .local v8, "causeExceptionCache":Ljava/lang/Object;
    goto :goto_3

    .end local v8    # "causeExceptionCache":Ljava/lang/Object;
    .restart local v0    # "causeExceptionCache":Ljava/lang/Object;
    :cond_8
    move-object v8, v0
    ...
    .line 753
    .local v0, "causeException":Ljava/lang/Throwable;
    .restart local v8    # "causeExceptionCache":Ljava/lang/Object;
    :goto_3
    move-object v5, v3
    ...
    invoke-direct {p0, v5, v0}, Lkotlinx/coroutines/JobSupport;->tryMakeCancelling(Lkotlinx/coroutines/Incomplete;Ljava/lang/Throwable;)Z
    ...
    invoke-direct {v5, v0, v7, v9, v6}, Lkotlinx/coroutines/CompletedExceptionally;-><init>(Ljava/lang/Throwable;ZILkotlin/jvm/internal/DefaultConstructorMarker;)V

    invoke-direct {p0, v3, v5}, Lkotlinx/coroutines/JobSupport;->tryMakeCompleting(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    .restart local v3    # "state":Ljava/lang/Object;
    .restart local v4    # "$i$a$-loopOnState-JobSupport$makeCancelling$1":I
    .restart local v5    # "finalState":Ljava/lang/Object;
    :cond_c
